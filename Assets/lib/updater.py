...
def update_assets(version_type: VersionType, cdnurl: str, newhashes: str, useragent: str, client_directory: Path):
...
def update(version_result: VersionResult, cdnurl: str, useragent: str, client_directory: Path):
